...
IEEE_adni.py gives the code to replicate results under Table III of the paper for the ADNI dataset.

mnist_code.py gives the code to replicate results under Table IV of the paper for the MNIST dataset.
